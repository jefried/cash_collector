...
class SwitchActivityState extends StatefulWidget {
  const SwitchActivityState({Key? key}) : super(key: key);

  @override
  _SwitchActivityStateState createState() => _SwitchActivityStateState();
}

class _SwitchActivityStateState extends State<SwitchActivityState> {
